...
The project uses environment variables to configure each application. To set up your local environment:

1. Copy the example environment files to create your local environments:
